...
protocol SearchPresenterInput: AuthorizedPresenter {
    ...
    func showSearchView()
    func presentImage(with imageUrl: URL, imageId: String)
}
...
extension SearchPresenter: SearchPresenterInput {
    ...
    func presentImage(with imageUrl: URL, imageId: String) {
        guard let photoViewController = PhotoViewController(imageUrl: imageUrl, imageId) else { return }
        output?.present(photoViewController: photoViewController)
    }
}
